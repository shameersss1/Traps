...
public class MyNotificationOpenedHandler implements OneSignal.NotificationOpenedHandler {
    ...
    public void notificationOpened(OSNotificationOpenResult result) {
        ...
        if (data != null) {
            ...
            if (activityToBeOpened != null && activityToBeOpened.equals("Question")) {
                Log.i("OneSignalExample", "customkey set with value: " + activityToBeOpened);

            } else if (activityToBeOpened != null && activityToBeOpened.equals("Result")) {
                Log.i("OneSignalExample", "customkey set with value: " + activityToBeOpened);

            } else {
                Intent intent = new Intent(MyApplication.getContext(),View12.class);
        ...
        {
            Intent intent = new Intent(MyApplication.getContext(), Home.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK);
            MyApplication.getContext().startActivity(intent);
        }
